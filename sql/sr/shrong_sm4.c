...
int SR_SM4_set_key(const uint8_t *key, SR_SM4_KEY *ks)
{
    ...
    for (i = 0; i != SR_SM4_KEY_SCHEDULE; ++i)
    {
...
#define SR_SM4_RNDS(k0, k1, k2, k3, F)         \
    do                                      \
    {                                       \
...
void SR_SM4_encrypt(const uint8_t *in, uint8_t *out, const SR_SM4_KEY *ks)
{
     ...
     */
    SR_SM4_RNDS(0, 1, 2, 3, SM4_T_slow);
    SR_SM4_RNDS(4, 5, 6, 7, SM4_T);
    SR_SM4_RNDS(8, 9, 10, 11, SM4_T);
    SR_SM4_RNDS(12, 13, 14, 15, SM4_T);
    SR_SM4_RNDS(16, 17, 18, 19, SM4_T);
    SR_SM4_RNDS(20, 21, 22, 23, SM4_T);
    SR_SM4_RNDS(24, 25, 26, 27, SM4_T);
    SR_SM4_RNDS(28, 29, 30, 31, SM4_T_slow);
...
void SR_SM4_decrypt(const uint8_t *in, uint8_t *out, const SR_SM4_KEY *ks)
{
    ...
    SR_SM4_RNDS(31, 30, 29, 28, SM4_T_slow);
    SR_SM4_RNDS(27, 26, 25, 24, SM4_T);
    SR_SM4_RNDS(23, 22, 21, 20, SM4_T);
    SR_SM4_RNDS(19, 18, 17, 16, SM4_T);
    SR_SM4_RNDS(15, 14, 13, 12, SM4_T);
    SR_SM4_RNDS(11, 10, 9, 8, SM4_T);
    SR_SM4_RNDS(7, 6, 5, 4, SM4_T);
    SR_SM4_RNDS(3, 2, 1, 0, SM4_T_slow);
